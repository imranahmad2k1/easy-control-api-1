...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('nonrentalunittypes', function (Blueprint $table) {
            ...
            $table->integer('GCRecord')->nullable()->index('iGCRecord_NonRentalUnitTypes');
        });
    }
    ...
    {
        Schema::dropIfExists('nonrentalunittypes');
    }
};
