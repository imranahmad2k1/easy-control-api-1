...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('housekeepingdays', function (Blueprint $table) {
            ...
            $table->integer('GCRecord')->nullable()->index('iGCRecord_HouseKeepingDays');
        });
    }
    ...
    {
        Schema::dropIfExists('housekeepingdays');
    }
};
