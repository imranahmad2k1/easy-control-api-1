...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('roomratetypes', function (Blueprint $table) {
            ...
            $table->integer('IsHourly')->nullable();
            $table->integer('IsDaily')->nullable();
            $table->integer('OptimisticLockField')->nullable();
            $table->integer('GCRecord')->nullable()->index('iGCRecord_RoomRateTypes');
        });
    }
    ...
    {
        Schema::dropIfExists('roomratetypes');
    }
};
