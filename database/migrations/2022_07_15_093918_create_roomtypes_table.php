...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('roomtypes', function (Blueprint $table) {
            ...
            $table->integer('NoOfBaseAdults')->nullable();
            $table->integer('NoOfBaseChilds')->nullable();
            $table->integer('NoOfMaxAdults')->nullable();
            $table->integer('NoOfMaxChilds')->nullable();
            $table->integer('OptimisticLockField')->nullable();
            $table->integer('GCRecord')->nullable()->index('iGCRecord_RoomTypes');
        });
    }
