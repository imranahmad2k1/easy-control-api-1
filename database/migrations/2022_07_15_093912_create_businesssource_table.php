...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('businesssource', function (Blueprint $table) {
            ...
            $table->integer('GCRecord')->nullable()->index('iGCRecord_BusinessSource');
            
            $table->foreign('MarketPlace', 'FK_BusinessSource_MarketPlace')->references('id')->on('marketplace');
        });
    }
    ...
    {
        Schema::dropIfExists('businesssource');
    }
};
