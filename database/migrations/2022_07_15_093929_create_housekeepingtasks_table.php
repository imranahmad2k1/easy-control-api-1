...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('housekeepingtasks', function (Blueprint $table) {
            ...
            $table->integer('GCRecord')->nullable()->index('iGCRecord_HouseKeepingTasks');
        });
    }
    ...
    {
        Schema::dropIfExists('housekeepingtasks');
    }
};
